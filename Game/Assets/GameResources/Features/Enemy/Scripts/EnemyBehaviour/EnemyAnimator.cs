...
namespace BattleArena.Enemy
{
    public class EnemyAnimator : MonoBehaviour, IAnimationStateReader
    {
        ...
        public event Action<AnimatorState> onStateEntered = delegate { };
        public event Action<AnimatorState> onStateExited = delegate { };
        ...
        public void ExitedState(int stateHash) => onStateExited(StateFor(stateHash));
